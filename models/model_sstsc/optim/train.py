...
from models.model_sstsc.dataloader.ucr2018 import UCR2018, MultiUCR2018_Intra
...
import models.model_sstsc.utils.transforms as transforms_ts
...
def semisupervised_train(x_train, y_train, x_val, y_val, x_test, y_test, opt):
    ...
    # Those are the transformations used in the paper  这些是本文中使用的转换
